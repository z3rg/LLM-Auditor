import{fileURLToPath as __f}from'node:url';import{dirname as __d}from'node:path';import{createRequire as __cr}from'node:module';const __filename=__f(import.meta.url);const __dirname=__d(__filename);const require=__cr(import.meta.url);
...
var require_serverless = __commonJS({
  "node_modules/@neondatabase/serverless/index.js"(exports, module) {
    ...
    var si = T((Le) => {
      "use strict";
      p();
      var Wt = Nn(), Re = Wn(), jn = typeof Symbol == "function" && typeof Symbol.for == "function" ? /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") : null;
      Le.Buffer = h;
      Le.SlowBuffer = Qo;
    ...
    var vs = T((ph, bs) => {
      "use strict";
      p();
      var { Transform: Gu } = (Er(), O(Sr)), { StringDecoder: Vu } = (ms(), O(ys)), Se = /* @__PURE__ */ Symbol(
        "last"
...
var require_pg = __commonJS({
  "lib/pg.js"(exports, module) {
    ...
    module.exports = { query, many, one, exec, scalar, reset };
  }
});
...
var require_auth = __commonJS({
  "lib/auth.js"(exports, module) {
    ...
    function hashPassword(plain) {
      ...
      const key = crypto2.scryptSync(plain, salt, SCRYPT.keylen, { N: SCRYPT.N, r: SCRYPT.r, p: SCRYPT.p });
    ...
    function verifyPassword(plain, stored) {
      ...
      let actual;
      try {
        actual = crypto2.scryptSync(plain, salt, expected.length, { N: Number(N), r: Number(r), p: Number(p) });
      } catch (_) {
        return false;
      }
