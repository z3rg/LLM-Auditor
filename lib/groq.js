 ...
 * plus the three AI features:
 *   1. Knowledge-gap recommendation
 *   2. Quiz-topic recommendation
 *   3. SQL Agent (natural language -> safe read-only SQL)
 */
...
// ---------------------------------------------------------------------------
// Quiz generation — framework ReAct (Reason + Act) dengan RAG (sqlite-vec)
// ---------------------------------------------------------------------------
...
//   2. Retrieval sqlite-vec TERPISAH untuk tiap sub-konsep (1 soal = 1 blok materi).
